                ...
                HStack(spacing: 8) {
                    Button {
                        ...
                        Text("All")
                            ...
                            .clipShape(Capsule())
                            .overlay(Capsule().stroke(selectedEchoId == nil ? Color.clear : Color.gray.opacity(0.3), lineWidth: 1))
                    }
                    ...
                    ForEach(activeEchos) { echo in
                        Button {
                            ...
                            .clipShape(Capsule())
                            .overlay(Capsule().stroke(selectedEchoId == echo.id ? Color.clear : Color.gray.opacity(0.3), lineWidth: 1))
                        }
                    }
                }
                .padding(.horizontal, 16)
